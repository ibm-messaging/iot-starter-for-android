...
The Eclipse Paho MQTT Android Service is used to publish and subscribe to the Watson IoT Platform. This can be downloaded from
...
In order to try the application as a registered device, you must have a Watson IoT Platform organization. This can be done by signing up for an IBM Bluemix trial and creating an instance of the Internet of Things Platform service. This will create an IoT organization where you can register devices. Next, you must register your device with your organization. When registering your device, create a new device type called `Android` (case sensitive). More detailed instructions on registering devices can be found in the [Watson Internet of Things Platform documentation](https://docs.internetofthings.ibmcloud.com/index.html).
